  ...
  return (
    ...
    <div className="App">
      ...
      <div className="flex my-4">
        <div className="w-1/3 bg-gray-400 h-12"></div>
        <h1 className="w-1/3 bg-gray-500 h-12 text-3xl text-white font-bold"> Solution steps </h1>
        <div className="w-1/3 bg-gray-400 h-12"></div>
      </div>
      {formSubmited && (
        <PuzzleSteps validNumbers={validNumbers} numbers={values} mapSize={mapSize} />
      )}
    </div>
  );
}
